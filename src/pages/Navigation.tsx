    ...
    <div className="flex w-full h-full relative overflow-hidden bg-[#f0f0f0] dark:bg-[#1a1a1a]">
      ...
      <div className="flex-1 relative bg-[#e0e0e0] dark:bg-[#202020]">
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 z-30 flex flex-col gap-4">
          <GlassButton className="w-14 h-14 p-0 rounded-full shadow-liquid glass border-white/20" aria-label="Search route">
            <Search size={24} strokeWidth={2.5} />
          </GlassButton>
          <GlassButton className="w-14 h-14 p-0 rounded-full shadow-liquid glass border-white/20" aria-label="Voice instructions">
