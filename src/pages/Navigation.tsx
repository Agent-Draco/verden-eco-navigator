    ...
    <div className="flex w-full h-full relative overflow-hidden bg-[#f0f0f0] dark:bg-[#1a1a1a]">
      ...
      <div className="flex-1 relative bg-[#e0e0e0] dark:bg-[#202020]">
        ...
        <div className="absolute right-4 top-1/2 -translate-y-1/2 z-30 flex flex-col gap-4">
          <GlassButton aria-label="Search map" className="w-14 h-14 p-0 rounded-full shadow-liquid glass border-white/20">
            <Search aria-hidden="true" size={24} strokeWidth={2.5} />
          </GlassButton>
          <GlassButton aria-label="Volume settings" className="w-14 h-14 p-0 rounded-full shadow-liquid glass border-white/20">
            <svg aria-hidden="true" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M11 5L6 9H2v6h4l5 4V5z"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/></svg>
          </GlassButton>
          <GlassButton aria-label="Report issue" className="w-14 h-14 p-0 rounded-full shadow-liquid bg-[#fdbd2d] text-black border-none font-black text-2xl">
