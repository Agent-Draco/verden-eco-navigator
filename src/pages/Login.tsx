    ...
    <div className="mobile-container bg-abstract">
      <div className="relative z-10 flex flex-col min-h-screen px-8 pt-20 pb-12">
        ...
        <div className="space-y-4 mb-6">
          ...
          <GlassCard className="flex items-center gap-3 px-4 py-4">
            ...
            <button
              ...
              className="text-muted-foreground hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background rounded-sm transition-colors"
          ...
          <Link to="/forgot-password" className="block text-xs text-primary text-right">Forgot password?</Link>
        </div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-8">
          <GlassButton variant="glass" size="sm" className="flex items-center justify-center gap-2 text-sm">
