      ...
      <GlassCard className="p-4 shadow-lg border-primary/5">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="flex gap-1">
            <GlassButton size="icon" variant="glass" onClick={() => setCurrentDate(new Date(currentDate.setMonth(currentDate.getMonth() - 1)))} aria-label="Previous month"><ChevronLeft size={16}/></GlassButton>
            <GlassButton size="icon" variant="glass" onClick={() => setCurrentDate(new Date(currentDate.setMonth(currentDate.getMonth() + 1)))} aria-label="Next month"><ChevronRight size={16}/></GlassButton>
          </div>
        </div>
