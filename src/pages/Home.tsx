          ...
          >
            ...
            <div className="flex flex-col gap-3">
                <div className="flex justify-around bg-white/5 backdrop-blur-xl rounded-[24px] p-1 gap-1 border border-white/10 shadow-liquid">
                    <GlassButton onClick={() => setTransportMode('car')} variant={transportMode === 'car' ? 'default' : 'glass'} size="icon" className="flex-1 h-12 text-foreground rounded-[20px]" aria-label="Car"><Car size={20} aria-hidden="true"/></GlassButton>
                    <GlassButton onClick={() => setTransportMode('bike')} variant={transportMode === 'bike' ? 'default' : 'glass'} size="icon" className="flex-1 h-12 text-xl rounded-[20px]" aria-label="Motorcycle"><span aria-hidden="true">🏍️</span></GlassButton>
                    <GlassButton onClick={() => setTransportMode('cycle')} variant={transportMode === 'cycle' ? 'default' : 'glass'} size="icon" className="flex-1 h-12 text-foreground rounded-[20px]" aria-label="Bicycle"><Bike size={20} aria-hidden="true"/></GlassButton>
                    <GlassButton onClick={() => setTransportMode('public')} variant={transportMode === 'public' ? 'default' : 'glass'} size="icon" className="flex-1 h-12 text-foreground rounded-[20px]" aria-label="Public Transport"><Bus size={20} aria-hidden="true"/></GlassButton>
                </div>
