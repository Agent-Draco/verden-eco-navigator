...
const SidebarNav = () => {
  ...
  return (
    <div className="hidden md:flex flex-col items-center py-6 w-20 border-r border-border bg-background/80 backdrop-blur-xl h-screen z-[50] shrink-0">
      ...
      <div className="mb-8">
        <button 
          className="p-3 rounded-2xl hover:bg-muted text-muted-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
        ...
        {navItems.map(({ icon: Icon, label, path }) => {
          ...
          return (
            <button
              ...
              className={cn(
                "group relative flex flex-col items-center justify-center p-3 rounded-2xl transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50",
                active 
      ...
      <div className="mt-auto">
        <button 
          ...
          className="p-3 rounded-2xl text-muted-foreground hover:bg-muted hover:text-foreground transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/50"
