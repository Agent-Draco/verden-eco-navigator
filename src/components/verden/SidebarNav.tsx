        ...
        {navItems.map(({ icon: Icon, label, path }) => {
          ...
          return (
            ...
            >
              ...
              {/* Tooltip-like label */}
              <span className="text-[10px] font-bold mt-1 opacity-0 group-hover:opacity-100 group-focus-visible:opacity-100 transition-opacity whitespace-nowrap" aria-hidden="true">
                {label}
              </span>
