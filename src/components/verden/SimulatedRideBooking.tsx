                ...
                {rideOptions.map(opt => {
                    ...
                    return (
                        <GlassCard 
                            ...
                            className={`p-3 flex items-center justify-between cursor-pointer border-2 focus-visible:ring-2 focus-visible:ring-primary focus-visible:outline-none transition-all ${selectedOption.type === opt.type ? 'border-primary/50' : 'border-transparent'}`}>
