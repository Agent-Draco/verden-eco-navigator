...
export const GlassButton = ({ 
  ...
  const base = "font-display font-bold rounded-[24px] transition-all duration-500 ease-in-out active:scale-95 relative overflow-hidden flex items-center justify-center";
