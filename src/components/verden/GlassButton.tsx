...
export const GlassButton = ({ 
  ...
  const base = "font-display font-bold rounded-[24px] transition-all duration-500 disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 relative overflow-hidden flex items-center justify-center";
  ...
  return (
    <motion.button
      {...props}
      style={{ transitionTimingFunction: "cubic-bezier(0.23,1,0.32,1)", ...props.style }}
      className={cn(
        base, 
        variants[variant], 
        sizes[size], 
