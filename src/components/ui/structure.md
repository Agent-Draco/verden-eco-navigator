# Structure.md (src/components/ui)

## Overview
This directory contains low-level, reusable UI primitives built on Radix UI and styled with Tailwind CSS.
...
- **use-toast.ts** - Hook for triggering toast notifications from any component.
